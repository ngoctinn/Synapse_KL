  ...
  "inline-flex items-center justify-center rounded-md border font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-[hsl(var(--alert-success-border))] bg-[hsl(var(--alert-success))] text-[hsl(var(--alert-success-foreground))] hover:bg-[hsl(var(--alert-success))]/80",
        warning:
          "border-[hsl(var(--alert-warning-border))] bg-[hsl(var(--alert-warning))] text-[hsl(var(--alert-warning-foreground))] hover:bg-[hsl(var(--alert-warning))]/80",
        error:
          "border-transparent bg-destructive/15 text-destructive hover:bg-destructive/25",
        "soft-error":
