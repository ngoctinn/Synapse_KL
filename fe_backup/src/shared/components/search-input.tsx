  ...
  "flex items-center gap-2 rounded-lg border bg-card transition-all",
  {
    variants: {
      ...
      state: {
        ...
        success: "border-alert-success-border focus-within:ring-2 focus-within:ring-alert-success/20",
        warning: "border-alert-warning-border focus-within:ring-2 focus-within:ring-alert-warning/20",
